...
class Invitation(CRideModel):
    ...
    Una invitación circular es un texto aleatorio que actúa como
    un código único que otorga acceso a un círculo específico.
    Estos códigos son generados por usuarios que ya están
    miembros del círculo y tienen un "invitaciones_ restantes"
    valor mayor que 0.
    """
